...
namespace Apache.Hadoop.Hbase.Thrift
{
  ...
  public partial class TRegionInfo : TBase
  {
    ...
    {
      var other = that as TRegionInfo;
      if (other == null) return false;
      if (ReferenceEquals(this, other)) return true;
      return ((__isset.startKey == other.__isset.startKey) && ((!__isset.startKey) || (System.Object.Equals(StartKey, other.StartKey))))
        ...
        && ((__isset.serverName == other.__isset.serverName) && ((!__isset.serverName) || (System.Object.Equals(ServerName, other.ServerName))))
